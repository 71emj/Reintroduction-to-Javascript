...
function initialize() {
    ...
    var category = document.querySelector('#category'); //serach terms
    var searchTerm = document.querySelector('#searchTerm'); //serach terms
    var searchBtn = document.querySelector('button'); //e.target
    var main = document.querySelector('main'); //display in main
